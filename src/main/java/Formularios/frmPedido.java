...
public class frmPedido extends javax.swing.JFrame {
        ...
        tablaPedidos.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent Mouse_evt){
                ...
                if(Mouse_evt.getClickCount()==1){
                    ...
                    btnImprimeGuia.setEnabled(true);
                }
           } 
        });
    ...
    private void initComponents() {
        ...
        btnImprimeGuia.setEnabled(false);
        btnImprimeGuia.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnImprimeGuiaActionPerformed(evt);
            }
        });
        panelFondo.add(btnImprimeGuia, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 650, 190, 40));
        ...
        panelFondo.add(txtCodigoPed_Guia, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 650, 110, 40));
